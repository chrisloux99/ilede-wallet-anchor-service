...
```bash
git remote add encore encore://ilede-wallet-anchor-service-6s52
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ilede-wallet-anchor-service-6s52/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ilede-wallet-anchor-service-6s52/settings/integrations/github)
